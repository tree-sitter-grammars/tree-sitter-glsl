LANGUAGE_NAME := tree-sitter-glsl
HOMEPAGE_URL := git://github.com/thehamsta/tree-sitter-glsl.git
VERSION := 0.3.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/glsl '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/glsl
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/glsl
